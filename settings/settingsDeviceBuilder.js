...
function newCapability_button(device, name) {
  ...
  _newCapability_button.name = name.toUpperCase(); //uuid;
...
function newCapability_slider(device, name, range, unit) {
  ...
  _newCapability_sensor.name = name.toUpperCase() + "_SENSOR"; //uuid + "_SENSOR";
  ...
  _newCapability_slider.name = name.toUpperCase(); //uuid;
...
function newCapability_switch(device, name) {
  ...
  _newCapability_switch.name = name.toUpperCase(); //uuid;
...
function newCapability_textlabel(device, name, isLabelVisible) {
  ...
  _newCapability_textlabel.name = name.toUpperCase(); //uuid;
...
function newCapability_image(device, name, size) {
  ...
  _newCapability_image.name = name.toUpperCase(); //uuid;
