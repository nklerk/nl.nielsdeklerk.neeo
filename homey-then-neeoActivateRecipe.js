...
neeoActivateRecipeRoom.registerAutocompleteListener((query, args) => {
  return homeyAutocomplete.rooms(query, args);
});

let neeoActivateRecipeRecipe = neeoActivateRecipe.getArgument("recipe");
neeoActivateRecipeRecipe.registerAutocompleteListener((query, args) => {
  return homeyAutocomplete.recepies(query, args, "launch");
});
