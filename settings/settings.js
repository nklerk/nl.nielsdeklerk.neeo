    ...
    for (let i in Settings_brains) {
        if (Settings_brains[i].host === selection){
            ...
            .then((systemInfo) => {
                ...
                dd = dd + '<b style="position: absolute;left: 250px;"> CPU (1 Min. Avg.):</b><div style="position: absolute;left: 400px;"><progress value="'+systemInfo.loadavgShort+'" max="1"></progress> '+Math.round(systemInfo.loadavgShort*50)+'%</div><br>';
                dd = dd + '<b style="position: absolute;left: 250px;"> CPU (5 Min. Avg.):</b><div style="position: absolute;left: 400px;"><progress value="'+systemInfo.loadavgMid+'" max="1"></progress> '+Math.round(systemInfo.loadavgMid*50)+'%</div><br>';
                dd = dd + '<b style="position: absolute;left: 250px;"> CPU (15 Min. Avg.):</b><div style="position: absolute;left: 400px;"><progress value="'+systemInfo.loadavgLong+'" max="1"></progress> '+Math.round(systemInfo.loadavgLong*50)+'%</div><br>';
